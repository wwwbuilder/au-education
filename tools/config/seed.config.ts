...
export class SeedConfig {
  ...
  APP_ASSETS: InjectableDependency[] = [
    ...
    { src: `${this.CSS_SRC}/core.css`, inject: true, vendor: false },
    { src: `${this.CSS_SRC}/colors.css`, inject: true, vendor: false },
    { src: `${this.CSS_SRC}/components.css`, inject: true, vendor: false },
